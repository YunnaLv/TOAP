...
class y_dequantize(nn.Module):
    ...
    def __init__(self, factor=1):
        ...
        self.y_table = utils.y_table.cuda()
        self.factor = factor
...
class c_dequantize(nn.Module):
    ...
    def __init__(self, factor=1):
        ...
        self.factor = factor
        self.c_table = utils.c_table.cuda()
...
class decompress_jpeg(nn.Module):
    ...
    def __init__(self, height, width, rounding=torch.round, factor=1, test=False):
    ...
    def forward(self, y, cb, cr):
        ...
        if self.test == False:
            ...
            image = (image - 0.5) * 2  # (-1,1)   mean std 0.5
            return image
        else:
