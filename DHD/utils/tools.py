...
def config_dataset(config):
    ...
    if config["dataset"] == "vggfaces2":
        config["topK"] = 300
        config["n_class"] = 28
        config["data_path"] = "/data/UTAH_datasets/vggfaces2/"
    elif config["dataset"] == "vggfaces2_2":
        config["topK"] = 300
        config["n_class"] = 28
        config["data_path"] = ""
    elif config["dataset"] == "vggfaces2_3":
        config["topK"] = 300
        config["n_class"] = 28
        config["data_path"] = ""
    elif config["dataset"] == "vggfaces2_4":
        config["topK"] = 300
        config["n_class"] = 28
        config["data_path"] = ""
...
def image_transform(resize_size, crop_size, data, dataset):   # data(train, test, database), dataset(CASIA..)
    ...
    #     mean_, std_ = [0.566, 0.436, 0.377], [0.277, 0.241, 0.230]
    # elif dataset == 'vggfaces2_3':
    #     mean_, std_ = [0.581, 0.453, 0.392], [0.274, 0.241, 0.231]
    # elif dataset == 'vggfaces2_4':
    #     mean_, std_ = [0.579, 0.442, 0.377], [0.277, 0.240, 0.228]
