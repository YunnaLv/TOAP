    ...
    if 'ResNet' in specific_model:
        if 'DHD' in model_path:
            ...
            if specific_model == 'ResNet34':
                fc_dim, N_bits, NB_CLS = 512, hash_bit, 28
...
if __name__ == '__main__':
    # ######## 64bit CSQ
    save_path1 = "/data/UTAH_code/UTRAP/save/DHD/ResNet34/CASIA/0.869687195299002/"  # CSQ-ResNet34
    save_path2 = "/data/UTAH_code/UTRAP/save/DHD/ResNet50/CASIA/0.8800455141879524/"  # CSQ-ResNet50
    save_path3 = "/data/UTAH_code/UTRAP/save/DHD/Vgg16/CASIA/0.8467041889233055/"  # CSQ-Vgg16
    save_path4 = "/data/UTAH_code/UTRAP/save/DHD/Vgg19/CASIA/0.8567496995111971/"  # CSQ-Vgg19
    ...
    noise_path = '/data/UTAH_code/UTRAP/exp/DHD/Vgg16/CASIA/UTRAP_15/'
    ...
    # for m in [19, 20, 21, 22]:
        ...
        log.info("mAP:" + str(org_mAP) + "->" + str(per_mAP))
        # if m == 7:
        #     # np.save('./codes/DHD_Res_CASIA_wComG_org_white_jpeg_md4.npy', org_codes2.numpy())
        #     np.save('./codes/DHD_Vgg_CASIA_wComG_org_white_jpeg_md7.npy', org_codes3.numpy())
        #     # np.save('./codes/DHD_Res_CASIA_wComG_per_white_jpeg_md4.npy', per_codes2.numpy())
        #     np.save('./codes/DHD_Vgg_CASIA_wComG_per_white_jpeg_md7.npy', per_codes3.numpy())
        # if m == 14:
        #     # np.save('./codes/DHD_Res_CASIA_wComG_org_white_blur_md12.npy', org_codes2.numpy())
        #     np.save('./codes/DHD_Vgg_CASIA_wComG_org_white_blur_md14.npy', org_codes3.numpy())
        #     # np.save('./codes/DHD_Res_CASIA_wComG_per_white_blur_md12.npy', per_codes2.numpy())
        #     np.save('./codes/DHD_Vgg_CASIA_wComG_per_white_blur_md14.npy', per_codes3.numpy())